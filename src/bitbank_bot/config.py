...
Master Policy numbers live here. Dataclass defaults, load_config, .env.example,
and docs/MASTER-POLICY.md must stay identical.
"""
...
# --- Master Policy (single source of truth) ---
PAIR = "btc_jpy"
...
class Config:
    ...
    def safe_dict(self) -> dict[str, object]:
        return {
            ...
            "wiki_cross_rules": self.wiki_cross_rules,
            "mtf_health": self.mtf_health,
