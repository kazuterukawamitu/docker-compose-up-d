    ...
    *,
    ...
    if cfg.has_keys:
        try:
            ...
            slog("PRIVATE_API", "BALANCE_FETCH=OK")
        ...
        slog("CONFIG", f"{cfg.trading_mode} continues without private keys")
