...
class RestClient:
    ...
    def get_depth(self, pair: str) -> dict[str, Any]:
        return self.public_get(f"/{pair}/depth")

    def get_transactions(self, pair: str, yyyymmdd: str | None = None) -> dict[str, Any]:
    ...
    def get_order(self, pair: str, order_id: int | str) -> dict[str, Any]:
        return self.private_get(
            "/user/spot/order", {"pair": pair, "order_id": str(order_id)}
        )
    ...
    def cancel_order(self, pair: str, order_id: int | str) -> dict[str, Any]:
        return self.private_post(
            "/user/spot/cancel_order",
            {"pair": pair, "order_id": int(order_id)},
            update=True,
        )

    def get_trade_history(self, pair: str, count: int = 10) -> dict[str, Any]:
        return self.private_get(
            "/user/spot/trade_history", {"pair": pair, "count": str(count)}
        )
