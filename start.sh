...
#
# Prefer the repo-root executable (no git checkout):
#   ./bitbank-bot
#
# This script still works. It only fetches a bot branch when src/bitbank_bot
# is missing (wiki-only main). If the Python package is already here, it
# starts immediately.
